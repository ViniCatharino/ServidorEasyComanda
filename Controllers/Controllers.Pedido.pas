...
begin
  ...
  try
    try
      ...
      itensAdicionais := body.GetValue<TJSONArray>('itensAdicionais');

      Res.Send<TJSONObject>(DAOPedido.InserirPedido(id_comanda, id_usuario, itens, itensAdicionais)).Status(201);
